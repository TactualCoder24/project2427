...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'font-sora font-semibold rounded-2xl transition-all duration-300 focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2';
  ...
  const variantClasses = {
    ...
    outline: 'border-2 border-accent text-accent hover:bg-accent hover:text-white hover:shadow-glow-md hover:scale-105 transform bg-surface/20 backdrop-blur-sm',
