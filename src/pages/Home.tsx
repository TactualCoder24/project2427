    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-black via-gray-900 to-black">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/4 left-1/4 w-4 h-4 bg-cyber-aqua rounded-full animate-float opacity-60 shadow-glow-sm" />
          ...
          <div className="absolute bottom-1/3 right-1/3 w-2 h-2 bg-cyber-aqua rounded-full animate-float opacity-45" style={{ animationDelay: '3s' }} />
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-20 sm:py-24 md:py-32">
          <div className="mb-6 sm:mb-8">
            <div className="inline-block px-4 sm:px-6 py-2 sm:py-3 glass-premium rounded-full text-xs sm:text-sm font-bold mb-6 sm:mb-8 animate-fadeInUp border border-cyber-aqua/30">
              <span className="text-gradient-intelligence">✨ AI Research & Innovation</span>
            </div>
          </div>
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold font-inter mb-6 sm:mb-8 animate-slideUp leading-[1.1]">
            ...
            <span className="block text-gradient-intelligence drop-shadow-2xl">Revolution</span>
          </h1>
          <div className="mb-6 sm:mb-8 animate-fadeInUp" style={{ animationDelay: '0.15s' }}>
            <p className="text-base sm:text-lg md:text-xl text-gray-400 font-inter italic">
              <span className="text-gradient-intelligence font-semibold">विद्वस्</span> (VIDVAS) - Sanskrit for <span className="text-gradient font-semibold">"Intelligence"</span>
            </p>
          </div>
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-200 mb-8 sm:mb-12 max-w-5xl mx-auto animate-fadeInUp font-inter font-light leading-relaxed px-6 sm:px-8" style={{ animationDelay: '0.2s' }}>
            Transform your business with <span className="text-gradient font-semibold">intelligent automation</span> that works{' '}
            <span className="text-signal-green font-bold">24/7</span> to streamline operations, enhance productivity, and drive{' '}
            <span className="text-gradient-quantum font-semibold">unprecedented growth</span>.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24">
            <div className="text-center animate-fadeInUp glass-premium p-8 rounded-2xl border border-cyber-aqua/20 hover-glow" style={{ animationDelay: '0.6s' }}>
              <div className="text-5xl font-bold text-gradient-intelligence mb-4 font-inter">Coming Soon</div>
            ...
            <div className="text-center animate-fadeInUp glass-premium p-8 rounded-2xl border border-hot-pink/20 hover-glow" style={{ animationDelay: '0.8s' }}>
              <div className="text-6xl font-bold text-gradient-quantum mb-4 font-inter">24/7</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card variant="gradient" className="p-10 text-center hover-glow animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
              <div className="w-20 h-20 bg-gradient-to-br from-cyber-aqua to-cyber-aqua rounded-2xl flex items-center justify-center mx-auto mb-8 animate-float shadow-glow-md">
                <span className="text-4xl">🧠</span>
              </div>
              <h3 className="text-3xl font-bold mb-6 font-inter text-gradient-intelligence">Autonomous Intelligence</h3>
            ...
            <Card variant="gradient" className="p-10 text-center hover-glow animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
              ...
              <h3 className="text-3xl font-bold mb-6 font-inter text-gradient-quantum">Enterprise Security</h3>
              <p className="text-gray-300 text-lg font-inter leading-relaxed">
      ...
      <section className="py-24 bg-gradient-to-b from-black via-gray-900 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold font-inter mb-6">
              Frequently Asked <span className="text-gradient-intelligence">Questions</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card variant="premium" className="p-8 hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient-intelligence font-inter">What are AI agents?</h3>
              <p className="text-gray-300 text-lg font-inter leading-relaxed">
            ...
            <Card variant="premium" className="p-8 hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient-quantum font-inter">Is my data secure?</h3>
              <p className="text-gray-300 text-lg font-inter leading-relaxed">
            ...
            <Card variant="premium" className="p-8 hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient-intelligence font-inter">What industries do you serve?</h3>
              <p className="text-gray-300 text-lg font-inter leading-relaxed">
            ...
            <Card variant="premium" className="p-8 hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient-quantum font-inter">What's the pricing model?</h3>
              <p className="text-gray-300 text-lg font-inter leading-relaxed">
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-cyber-aqua/10 via-vivid-purple/10 to-hot-pink/10 relative overflow-hidden">
