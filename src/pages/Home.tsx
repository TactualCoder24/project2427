    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-black via-gray-900 to-black">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-20 sm:py-24 md:py-32">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold font-outfit mb-6 sm:mb-8 animate-slideUp leading-[1.1]">
          ...
          <div className="mb-6 sm:mb-8 animate-fadeInUp" style={{ animationDelay: '0.15s' }}>
            <p className="text-base sm:text-lg md:text-xl text-gray-400 font-jakarta italic">
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-200 mb-8 sm:mb-12 max-w-5xl mx-auto animate-fadeInUp font-jakarta font-light leading-relaxed px-6 sm:px-8" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24">
            <div className="text-center animate-fadeInUp glass-premium p-8 rounded-2xl border border-electric-blue/20 hover-glow" style={{ animationDelay: '0.6s' }}>
              <div className="text-5xl font-bold text-gradient-cyber mb-4 font-outfit">Coming Soon</div>
              <div className="text-gray-300 text-xl font-jakarta font-medium">AI Agents Deployed</div>
            </div>
            <div className="text-center animate-fadeInUp glass-premium p-8 rounded-2xl border border-vivid-purple/20 hover-glow" style={{ animationDelay: '0.7s' }}>
              <div className="text-6xl font-bold text-gradient mb-4 font-outfit">10x</div>
              <div className="text-gray-300 text-xl font-jakarta font-medium">Productivity Boost</div>
            </div>
            <div className="text-center animate-fadeInUp glass-premium p-8 rounded-2xl border border-hot-pink/20 hover-glow" style={{ animationDelay: '0.8s' }}>
              <div className="text-6xl font-bold text-gradient-electric mb-4 font-outfit">24/7</div>
              <div className="text-gray-300 text-xl font-jakarta font-medium">Always Active</div>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="py-24 bg-gradient-to-b from-gray-900 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 animate-fadeInUp">
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold font-outfit mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card variant="gradient" className="p-10 text-center hover-glow animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
              ...
              <h3 className="text-3xl font-bold mb-6 font-outfit text-gradient-cyber">Autonomous Intelligence</h3>
              <p className="text-gray-300 text-lg font-jakarta leading-relaxed">
            ...
            <Card variant="gradient" className="p-10 text-center hover-glow animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
              ...
              <h3 className="text-3xl font-bold mb-6 font-outfit text-gradient">Lightning Fast</h3>
              <p className="text-gray-300 text-lg font-jakarta leading-relaxed">
            ...
            <Card variant="gradient" className="p-10 text-center hover-glow animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
              ...
              <h3 className="text-3xl font-bold mb-6 font-outfit text-gradient-electric">Enterprise Security</h3>
              <p className="text-gray-300 text-lg font-jakarta leading-relaxed">
      ...
      <section className="py-24 bg-gradient-to-b from-black via-gray-900 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto font-jakarta">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card variant="premium" className="p-8 hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient-cyber font-outfit">What are AI agents?</h3>
              <p className="text-gray-300 text-lg font-jakarta leading-relaxed">
            ...
            <Card variant="premium" className="p-8 hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient font-outfit">How quickly can I deploy an agent?</h3>
              <p className="text-gray-300 text-lg font-jakarta leading-relaxed">
            ...
            <Card variant="premium" className="p-8 hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient-electric font-outfit">Is my data secure?</h3>
              <p className="text-gray-300 text-lg font-jakarta leading-relaxed">
            ...
            <Card variant="premium" className="p-8 hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient-cyber font-outfit">What industries do you serve?</h3>
              <p className="text-gray-300 text-lg font-jakarta leading-relaxed">
            ...
            <Card variant="premium" className="p-8 hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient font-outfit">Do I need technical expertise?</h3>
              <p className="text-gray-300 text-lg font-jakarta leading-relaxed">
            ...
            <Card variant="premium" className="p-8 hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient-electric font-outfit">What's the pricing model?</h3>
              <p className="text-gray-300 text-lg font-jakarta leading-relaxed">
          ...
          <div className="text-center mt-16">
            <p className="text-gray-300 text-xl mb-8 font-jakarta">Have more questions?</p>
            <Link to="/contact">
      ...
      <section className="py-24 bg-gradient-to-r from-electric-blue/10 via-vivid-purple/10 to-hot-pink/10 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold font-outfit mb-8">
            Ready to <span className="text-gradient-animate">Transform</span> Your Business?
          </h2>
          <p className="text-2xl md:text-3xl text-gray-300 mb-12 font-jakarta">
