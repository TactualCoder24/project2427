    ...
    <div className="min-h-screen py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20 animate-fadeInUp">
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold font-outfit mb-8 animate-slideUp">
            About <span className="text-gradient-animate">VIDVAS AI</span>
          </h1>
          <div className="mb-8 animate-fadeInUp" style={{ animationDelay: '0.1s' }}>
            <p className="text-xl md:text-2xl text-gray-400 font-jakarta italic max-w-3xl mx-auto">
          ...
          <p className="text-2xl md:text-3xl text-gray-300 max-w-4xl mx-auto font-jakarta leading-relaxed animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <Card variant="gradient" className="p-10 hover-glow animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
              <div className="flex items-center mb-8">
                ...
                <h2 className="text-4xl font-bold font-outfit text-gradient-cyber">Our Mission</h2>
              </div>
              <p className="text-gray-300 text-xl font-jakarta leading-relaxed">
            ...
            <Card variant="gradient" className="p-10 hover-glow animate-fadeInUp" style={{ animationDelay: '0.5s' }}>
              <div className="flex items-center mb-8">
                ...
                <h2 className="text-4xl font-bold font-outfit text-gradient">Our Vision</h2>
              </div>
              <p className="text-gray-300 text-xl font-jakarta leading-relaxed">
        ...
        <section className="mb-24">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-bold font-outfit mb-6 text-gradient-electric">Our Approach</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card variant="premium" className="p-10 text-center hover-glow">
              ...
              <h3 className="text-2xl font-bold mb-6 font-outfit text-gradient-cyber">Research-Driven</h3>
            ...
            <Card variant="premium" className="p-10 text-center hover-glow">
              ...
              <h3 className="text-2xl font-bold mb-6 font-outfit text-gradient">Practical Implementation</h3>
              <p className="text-gray-300 text-lg font-jakarta leading-relaxed">
            ...
            <Card variant="premium" className="p-10 text-center hover-glow">
              ...
              <h3 className="text-2xl font-bold mb-6 font-outfit text-gradient-electric">Human-Centric</h3>
              <p className="text-gray-300 text-lg font-jakarta leading-relaxed">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card variant="gradient" className="p-8 text-center hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient-cyber font-outfit">Transparency</h3>
              <p className="text-base text-gray-300 font-jakarta leading-relaxed">
                Open and honest communication in all our interactions.
              </p>
            </Card>

            <Card variant="gradient" className="p-8 text-center hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient font-outfit">Innovation</h3>
              <p className="text-base text-gray-300 font-jakarta leading-relaxed">
            ...
            <Card variant="gradient" className="p-8 text-center hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient-electric font-outfit">Excellence</h3>
              <p className="text-base text-gray-300 font-jakarta leading-relaxed">
            ...
            <Card variant="gradient" className="p-8 text-center hover-glow">
              <h3 className="text-2xl font-bold mb-4 text-gradient-cyber font-outfit">Responsibility</h3>
              <p className="text-base text-gray-300 font-jakarta leading-relaxed">
